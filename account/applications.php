        ...
        <table>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        <td><?php echo $row['id_applications']; ?></td>
                        <td><?php echo $row['name']; ?></td>
                        <td><?php echo $row['number']; ?></td>
                        <td><?php echo $row['email']; ?></td>
                        <td><?php echo $row['status']; ?></td>
                        <td>
                            <a href="edit_application.php?id=<?php echo $row['id_applications']; ?>">Редактировать</a>
                            <a href="delete_application.php?id=<?php echo $row['id_applications']; ?>">Удалить</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
