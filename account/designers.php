...
// Получаем список дизайнеров из базы данных
...
<head>
    ...
    <title>Управление дизайнерами</title>
...
<header>
        <div class="logo">
          ...
          <a class="logo_name" href="../index.html">mesto</a>
        </div>
        <nav>
            <ul>
    ...
    <main>
        <h2>Дизайнеры</h2>
        <a href="add_designer.php">Добавить дизайнера</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><?php echo $row['datajob']; ?></td>
                        <td><?php echo $row['specialization']; ?></td>
                        <td>
                            <a href="edit_designer.php?id=<?php echo $row['id_designer']; ?>">Редактировать</a>
                            <a href="delete_designer.php?id=<?php echo $row['id_designer']; ?>">Удалить</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
